...
export const possiblePawnMovement = (currentPiece: Piece, activePieces: Piece[]): Position[] => {
  ...
  if (isTileFree(
      activePieces, 
      { column: currentPiece.position.column, row: normalMoveRow }, 
      currentPiece.team)) {
        ...
        if (hasMoved === false && 
          isTileFree(
            activePieces,
            { column: currentPiece.position.column, row: doubleMoveRow },
            currentPiece.team)) {
  ...
  if (isOnBoard(attackPositionOne) && 
      isTileTakenByOpponent(activePieces, attackPositionOne, currentPiece.team)) {
        positions.push(attackPositionOne);
  }

  if (isOnBoard(attackPositionTwo) &&
      isTileTakenByOpponent(activePieces, attackPositionTwo, currentPiece.team)) {
